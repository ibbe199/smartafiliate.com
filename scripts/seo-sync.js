...
function toAbsoluteUrl(rawUrl, filePath) {
  ...
  if (/^https?:\/\//i.test(rawUrl)) {
    return rawUrl.replace('https://www.smartafiliate.com', SITE_URL).replace('https://smartafiliate.com', SITE_URL);
  }
...
function toSiteRelativeUrl(absoluteUrl) {
  return absoluteUrl.replace(SITE_URL, '').replace('https://www.smartafiliate.com', '').replace('https://smartafiliate.com', '');
}
...
function updateHtml(filePath) {
  ...
  content = content.replace(/https:\/\/www\.smartafiliate\.com/g, SITE_URL).replace(/https:\/\/smartafiliate\.com/g, SITE_URL);
  if (content !== original) {
