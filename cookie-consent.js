...
(function () {
  function injectUnifiedLayoutFixes() {
    ...
    style.textContent = `
      ...
      /* تنظيم صفحة تعلم AI: الأفضل = كرت كامل بعرض الهاتف، و3 مقالات في صف واحد على الكمبيوتر */
      body:has(script[src*="learn-ai.js"]) .articles-grid{display:grid!important;grid-template-columns:1fr!important;gap:1.35rem!important;align-items:stretch!important}
      body:has(script[src*="learn-ai.js"]) .article-card{width:100%!important;height:100%!important;display:flex!important;flex-direction:column!important;border-radius:24px!important;overflow:hidden!important;box-shadow:0 14px 36px rgba(15,23,42,.08)!important;background:#fff!important}
      ...
      body:has(script[src*="learn-ai.js"]) .article-content{display:flex!important;flex-direction:column!important;flex:1!important;padding:1.35rem!important;text-align:right!important}
      body:has(script[src*="learn-ai.js"]) .article-card h3{font-size:1.18rem!important;line-height:1.65!important;margin-bottom:.75rem!important;color:#0b1f3a!important}
      body:has(script[src*="learn-ai.js"]) .article-excerpt{font-size:.96rem!important;line-height:1.85!important;color:#475569!important;margin-bottom:1rem!important}
      ...
      @media (min-width:760px){body:has(script[src*="learn-ai.js"]) .articles-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important;gap:1.8rem!important}}
      @media (min-width:1180px){body:has(script[src*="learn-ai.js"]) .articles-grid{grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:2rem!important}}
      @media (max-width:759px){body:has(script[src*="learn-ai.js"]) .container{width:min(100% - 1.4rem,1200px)!important}body:has(script[src*="learn-ai.js"]) .article-image{height:215px!important;min-height:215px!important}body:has(script[src*="learn-ai.js"]) .article-content{padding:1.15rem!important}body:has(script[src*="learn-ai.js"]) .article-card h3{font-size:1.08rem!important}.site-header .header-actions{display:none!important}}
    `;
