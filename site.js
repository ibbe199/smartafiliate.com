  ...
  function injectAffiliateCss() {
    ...
    const css = `
      ...
      @media(max-width:760px){
        ...
        .site-header .header-inner{display:grid!important;grid-template-columns:auto 1fr auto!important;align-items:center!important;gap:.55rem!important;min-height:58px!important;padding:.45rem .75rem!important;width:100%!important;max-width:100%!important;box-sizing:border-box!important;direction:rtl!important}
        .site-header .logo{grid-column:1!important;justify-self:start!important;font-size:1.02rem!important;white-space:nowrap!important;max-width:150px!important;overflow:hidden!important;text-overflow:ellipsis!important;z-index:2!important}
        .site-header .menu-toggle{grid-column:3!important;justify-self:end!important;display:inline-flex!important;align-items:center!important;justify-content:center!important;width:42px!important;height:42px!important;min-width:42px!important;border-radius:14px!important;background:#ea580c!important;color:#fff!important;border:1px solid rgba(255,255,255,.24)!important;font-size:1.35rem!important;font-weight:900!important;box-shadow:0 8px 18px rgba(234,88,12,.25)!important;z-index:3002!important;cursor:pointer!important}
