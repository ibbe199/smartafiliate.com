(function () {
  ...
  function installSafeFixes() {
    if (document.getElementById('smartafiliate-safe-fixes')) return;
    var style = document.createElement('style');
    style.id = 'smartafiliate-safe-fixes';
    style.textContent = '.logo{direction:ltr!important;unicode-bidi:isolate!important}.logo-text{direction:ltr!important;unicode-bidi:isolate!important}.logo-text-light{text-transform:capitalize!important}.site-header .logo{display:inline-flex!important;flex-direction:row!important}.smart-image-title{display:none!important}';
