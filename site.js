...
function loadCss(){
  ...
  l.id='header-fix-css';
  l.rel='stylesheet';
  l.href='/header-fix.css?v=20260501_PERF';
  document.head.appendChild(l);
}
function loadMenuScript(){
  if(document.getElementById('mobile-menu-js'))return;
  const s=document.createElement('script');
  s.id='mobile-menu-js';
  s.src='/mobile-menu.js?v=20260501a';
  s.defer=true;
...
function init(){loadCss();hardClean();buildHeader();optimizeImages();requestAnimationFrame(()=>{loadMenuScript();addAiFeatured();buildFooter();finalPass();});setTimeout(finalPass,900);}
