...
function loadCss(){let old=document.getElementById('header-fix-css');if(old)old.remove();const l=document.createElement('link');l.id='header-fix-css';l.rel='stylesheet';l.href='/header-fix.css?v=20260501k';document.head.appendChild(l);}
...
function cleanupMisplacedBlocks(){
  document.querySelectorAll('main .footer-col, main .footer-bottom, .hero .footer-col, .page-hero .footer-col, .hero .footer-bottom, .page-hero .footer-bottom, .hero .smart-global-contact, .page-hero .smart-global-contact').forEach(e=>e.remove());
}
function ensureFooterBlock(){
  document.querySelectorAll('.smart-global-footer').forEach(e=>e.remove());
  const html='<div class="smart-global-footer"><div class="container"><div class="smart-footer-brand"><img class="footer-logo-img" src="'+LOGO+'" alt="Smart Affiliate"></div><p class="smart-footer-contact">Contact: <a href="mailto:info@smartafiliate.com">info@smartafiliate.com</a></p><div class="smart-footer-policies"><a href="privacy-policy.html">سياسة الخصوصية</a><a href="cookie-policy.html">سياسة الكوكيز</a><a href="terms.html">الشروط والأحكام</a></div></div></div>';
  const footer=document.querySelector('footer,.site-footer');
  if(footer) footer.insertAdjacentHTML('beforeend',html);
